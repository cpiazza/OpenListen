 ...
 * Original file: C:\\Users\\Chris\\workspace\\OpenListen\\src\\cmp\\openlisten\\music\\IMediaPlaybackService.aidl
 */
package cmp.openlisten.music;
public interface IMediaPlaybackService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements cmp.openlisten.music.IMediaPlaybackService
{
private static final java.lang.String DESCRIPTOR = "cmp.openlisten.music.IMediaPlaybackService";
...
/**
 * Cast an IBinder object into an cmp.openlisten.music.IMediaPlaybackService interface,
 * generating a proxy if needed.
 */
public static cmp.openlisten.music.IMediaPlaybackService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof cmp.openlisten.music.IMediaPlaybackService))) {
return ((cmp.openlisten.music.IMediaPlaybackService)iin);
}
return new cmp.openlisten.music.IMediaPlaybackService.Stub.Proxy(obj);
}
...
private static class Proxy implements cmp.openlisten.music.IMediaPlaybackService
{
