...
import cmp.openlisten.common.activities.Recommend;
import cmp.openlisten.common.activities.WhosListening;
import cmp.openlisten.music.MusicUtils.ServiceToken;
    ...
    View.OnTouchListener, View.OnLongClickListener
{
    ...
    public void onCreate(Bundle icicle)
    {
        ...
        mReco = (ImageView) findViewById(R.id.player_control_reco);
        mReco.setOnClickListener(mRecoListener);
        mStar = (ImageView) findViewById(R.id.player_control_star);
        mStar.setOnClickListener(mStarListener);
        mWho = (ImageView) findViewById(R.id.player_control_who);
        mWho.setOnClickListener(mWhoListener);
    ...
    private View.OnClickListener mQueueListener = new View.OnClickListener() {
        public void onClick(View v) {
            startActivity(
                    new Intent(MusicUtils.ACTION_EDIT)
    ...
    private View.OnClickListener mRecoListener = new View.OnClickListener() {
		
		@Override
		public void onClick(View v) {
			Intent i = new Intent(mCtx, Recommend.class);
			startActivity(i);
		}
	};
	
    private View.OnClickListener mStarListener = new View.OnClickListener() {
		
		@Override
		public void onClick(View v) {
			Intent i = new Intent(mCtx, Rankings.class);
			startActivity(i);
		}
	};
	
    private View.OnClickListener mWhoListener = new View.OnClickListener() {
		
		@Override
		public void onClick(View v) {
			Intent i = new Intent(mCtx, WhosListening.class);
			startActivity(i);
		}
	};		
    ...
    public void onStart() {
        ...
        f.addAction(OLMediaPlaybackService.PLAYSTATE_CHANGED);
        f.addAction(OLMediaPlaybackService.META_CHANGED);
        f.addAction(OLMediaPlaybackService.PLAYBACK_COMPLETE);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (item != null) {
            ...
            if (shuffle == OLMediaPlaybackService.SHUFFLE_AUTO) {
    ...
    private void toggleShuffle() {
        ...
        try {
            ...
            if (shuffle == OLMediaPlaybackService.SHUFFLE_NONE) {
                mService.setShuffleMode(OLMediaPlaybackService.SHUFFLE_NORMAL);
                if (mService.getRepeatMode() == OLMediaPlaybackService.REPEAT_CURRENT) {
                    mService.setRepeatMode(OLMediaPlaybackService.REPEAT_ALL);
                    setRepeatButtonImage();
                }
                showToast(R.string.shuffle_on_notif);
            } else if (shuffle == OLMediaPlaybackService.SHUFFLE_NORMAL ||
                    shuffle == OLMediaPlaybackService.SHUFFLE_AUTO) {
                mService.setShuffleMode(OLMediaPlaybackService.SHUFFLE_NONE);
    ...
    private void cycleRepeat() {
        ...
        try {
            ...
            if (mode == OLMediaPlaybackService.REPEAT_NONE) {
                mService.setRepeatMode(OLMediaPlaybackService.REPEAT_ALL);
                showToast(R.string.repeat_all_notif);
            } else if (mode == OLMediaPlaybackService.REPEAT_ALL) {
                mService.setRepeatMode(OLMediaPlaybackService.REPEAT_CURRENT);
                if (mService.getShuffleMode() != OLMediaPlaybackService.SHUFFLE_NONE) {
                    mService.setShuffleMode(OLMediaPlaybackService.SHUFFLE_NONE);
                    setShuffleButtonImage();
                }
                showToast(R.string.repeat_current_notif);
            } else {
                mService.setRepeatMode(OLMediaPlaybackService.REPEAT_NONE);
    ...
    private void setRepeatButtonImage() {
        ...
        try {
            switch (mService.getRepeatMode()) {
                case OLMediaPlaybackService.REPEAT_ALL:
                    mRepeatButton.setImageResource(R.drawable.ic_mp_repeat_all_btn);
                    break;
                case OLMediaPlaybackService.REPEAT_CURRENT:
    ...
    private void setShuffleButtonImage() {
        ...
        try {
            switch (mService.getShuffleMode()) {
                case OLMediaPlaybackService.SHUFFLE_NONE:
                    mShuffleButton.setImageResource(R.drawable.ic_mp_shuffle_off_btn);
                    break;
                case OLMediaPlaybackService.SHUFFLE_AUTO:
    ...
    private BroadcastReceiver mStatusListener = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(OLMediaPlaybackService.META_CHANGED)) {
                // redraw the artist/title info and
                // set new max for progress bar
                updateTrackInfo();
                setPauseButtonImage();
                queueNextRefresh(1);
            } else if (action.equals(OLMediaPlaybackService.PLAYBACK_COMPLETE)) {
                if (mOneShot) {
                    finish();
                } else {
                    setPauseButtonImage();
                }
            } else if (action.equals(OLMediaPlaybackService.PLAYSTATE_CHANGED)) {
                setPauseButtonImage();
            }
        }
    };
