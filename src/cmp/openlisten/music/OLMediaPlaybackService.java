...
import cmp.openlisten.music.IMediaPlaybackService;

/**
 * Provides "background" audio playback capabilities, allowing the
 * user to switch between activities without stopping playback.
 */
public class OLMediaPlaybackService extends Service {
    ...
    public static final String PLAYSTATE_CHANGED = "cmp.openlisten.music.playstatechanged";
    public static final String META_CHANGED = "cmp.openlisten.music.metachanged";
    public static final String QUEUE_CHANGED = "cmp.openlisten.music.queuechanged";
    public static final String PLAYBACK_COMPLETE = "cmp.openlisten.music.playbackcomplete";
    public static final String ASYNC_OPEN_COMPLETE = "cmp.openlisten.music.asyncopencomplete";

    public static final String SERVICECMD = "cmp.openlisten.music.musicservicecommand";
    ...
    public static final String TOGGLEPAUSE_ACTION = "cmp.openlisten.music.musicservicecommand.togglepause";
    public static final String PAUSE_ACTION = "cmp.openlisten.music.musicservicecommand.pause";
    public static final String PREVIOUS_ACTION = "cmp.openlisten.music.musicservicecommand.previous";
    public static final String NEXT_ACTION = "cmp.openlisten.music.musicservicecommand.next";
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (CMDNEXT.equals(cmd) || NEXT_ACTION.equals(action)) {
                ...
                mAppWidgetProvider.performUpdate(OLMediaPlaybackService.this, appWidgetIds);
            }
        }
    };
...
//    };
            ...
            mUnmountReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if (action.equals(Intent.ACTION_MEDIA_EJECT)) {
                        ...
                        mMediaMountedCount++;
                        mCardId = MusicUtils.getCardId(OLMediaPlaybackService.this);
                        reloadQueue();
                        notifyChange(QUEUE_CHANGED);
                        notifyChange(META_CHANGED);
                    }
     ...
     * "cmp.openlisten.music.metachanged"
     * "cmp.openlisten.music.queuechanged",
     * "cmp.openlisten.music.playbackcomplete"
     * "cmp.openlisten.music.playstatechanged"
...
//                MediaButtonIntentReceiver.class.getName()));
        ...
        if (mPlayer.isInitialized()) {
            ...
            status.contentIntent = PendingIntent.getActivity(this, 0,
                    new Intent("cmp.openlisten.music.PLAYBACK_VIEWER")
    ...
    private class MultiPlayer {
        ...
        public MultiPlayer() {
            mMediaPlayer.setWakeMode(OLMediaPlaybackService.this, PowerManager.PARTIAL_WAKE_LOCK);
        }
        ...
        public void setDataSource(String path) {
            try {
                ...
                if (path.startsWith("content://")) {
                    mMediaPlayer.setDataSource(OLMediaPlaybackService.this, Uri.parse(path));
                } else {
                    mMediaPlayer.setDataSource(path);
                }
                mMediaPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);
    ...
    static class ServiceStub extends IMediaPlaybackService.Stub {
        WeakReference<OLMediaPlaybackService> mService;
        
        ServiceStub(OLMediaPlaybackService service) {
            mService = new WeakReference<OLMediaPlaybackService>(service);
        }
