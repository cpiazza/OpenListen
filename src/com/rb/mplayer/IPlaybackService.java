 ...
 */
package com.rb.mplayer;
public interface IPlaybackService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements IPlaybackService
{
private static final java.lang.String DESCRIPTOR = "com.rb.mplayer.IMediaPlaybackService";
...
/**
 * Cast an IBinder object into an com.rb.mplayer.IPlaybackService interface,
 * generating a proxy if needed.
 */
public static IPlaybackService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof IPlaybackService))) {
return ((IPlaybackService)iin);
}
return (IPlaybackService) new IPlaybackService.Stub.Proxy(obj);
}
