 ...
 * Original file: com/htc/music/IMediaPlaybackService.aidl
 */
...
static final int TRANSACTION_getSongInfo = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_playAlbum = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_openfile = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_openfileAsync = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_open = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_getQueuePosition = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_isPlaying = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_stop = (IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_pause = (IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_play = (IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_prev = (IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_next = (IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_duration = (IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_position = (IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_seek = (IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_getTrackName = (IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_getAlbumName = (IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getAlbumId = (IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_getArtistName = (IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_getArtistId = (IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_enqueue = (IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getQueue = (IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_moveQueueItem = (IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_setQueuePosition = (IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_getPath = (IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_getAudioId = (IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_setShuffleMode = (IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_getShuffleMode = (IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_removeTracks = (IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_removeTrack = (IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_setRepeatMode = (IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_getRepeatMode = (IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_getMediaMountedCount = (IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_startAnimation = (IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_endAnimation = (IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_setAlbumQueue = (IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_getAlbumQueue = (IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_getAlbumQueuePosition = (IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_activityGoSleep = (IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_activityWakeup = (IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_getQueueSize = (IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_getAlbumQueueSize = (IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_prevAlbum = (IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_nextAlbum = (IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_isSystemReady = (IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_reloadQueue = (IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_setMediaMode = (IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_syncNowPlayingQueue = (IBinder.FIRST_CALL_TRANSACTION + 47);
}
public java.lang.String getSongInfo(int id) throws android.os.RemoteException;
public int playAlbum(int id) throws android.os.RemoteException;
public void openfile(java.lang.String path) throws android.os.RemoteException;
